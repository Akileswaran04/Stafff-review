...
// Illustrative only — the format real codes follow, not real codes. Real ones are generated by
// scripts/generate-staff-directory.mjs and never appear in client-shipped code.
const EXAMPLES = ["DIST-4F7K2QRT", "DIST-9M3XZC5P", "DIST-K6QAN7W8"];
